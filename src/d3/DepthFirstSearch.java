...
public class DepthFirstSearch {
    public static void main(String[] args) {
        ...
        // 주어진 연결 정보를 바탕으로 adjMap을 채워넣는다. 연결되어 있다면 1
        // 1. 주어진 선의 갯수만큼 반복
        ...
        // 1. 가장 먼저 방문할 곳을 넣어둔다.
        toVisit.push(1);
        // 2. 스택이 빌때까지 반복한다. ( 더이상 방문할 곳이 없을 떄까지)
        while(!toVisit.empty()){ // 비어있지 않은 동안 반복
            // 3. 다음 방문할 곳을 pop한다.
            ...
            // 6. 다음 방문 대상을 스택에 push
            for(int i = nodeCount; i > 0; i--){ // 큰 숫자 먼저 저장
