...
//        array = new int[]{0, 1, 4, 4, 3, 0, 5, 2, 5, 1};
        ...
        int[] output = new int[array.length]; //array.length = 10
        // 뒤에서부터 순회하며 output 배열 채우기
        for (int i = array.length - 1; i >=0 ; i--) { //array.length - 1 = 9
            // 현재 원소의 마지막 위치를 조정
            counts[array[i]]--; // 뒤에서부터 하기 떄문에 --
